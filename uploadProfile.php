...
<div id="navbar">
	<table width="100%" border="0">
		<tr>
			<td>
				<img src="busicon.jpg" height="40px" width="50px" align="left">
			</td>
			<td align="right" style=" font-family:sans-serif;padding-left: 950px; ">
					<ul >
					<li><img src="userpic/<?php echo "$p"; ?>" style="text-align: center;margin-top: 7px;border-radius: 2px;"; height="30px" width="30px"></li>
					 <li class="dropdown">
   						 <a  class="dropbtn">
